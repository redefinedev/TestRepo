    ...
    steps {
        dockerCommand {
            ...
            commandType = build {
                ...
                commandArgs = """--build-arg TEAMCITY_PROJECT_NAME="%system.teamcity.projectName%" TEAMCITY_BUILD_NUMBER="%system.build.number%" TEAMCITY_BUILD_CONF_NAME="%system.teamcity.buildConfName%" TEAMCITY_BUILD_BRANCH="%teamcity.build.branch%""""
            }
        }
    }
